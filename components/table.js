            ...
            <tbody className="bg-gray-200">
                <tr className="bg-gray-50 text-center">
                    <td className="px-16 py-2 flex flex-row items-center">
                        <img src="" alt=""/>
                        <span className="text-center ml-2 font-semibold">Orlando Chavez</span>
                    </td>
                    ...
                    <td className="px-14 py-2">
                        <button className="cursor"><span className="bg-green-500 text-white px-2 py-1 rounded-full" >Active</span></button>
                    </td>
